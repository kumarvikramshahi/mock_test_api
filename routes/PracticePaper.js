...
const { fetchPracticePaper, postPracticePaper, editPracticePaper, addQuestion, editQuestion, deleteQuestion } = require('../controllers/Profile/PractisePaper');

router.get('/practice_paper/fetch/', fetchPracticePaper);
router.post('/practice_paper/post/', postPracticePaper);
router.patch('/practice_paper/edit/', editPracticePaper);
