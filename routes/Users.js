...
const { getUserProfile, patchUserProfile } = require('../controllers/Profile/Users')
const { postContestSession, fetchTeachSession, patchTeachSession } = require('../controllers/Session/ContestSession/ContestSession');
const { getUserList } = require('../controllers/PartialFetch/UsersList');
...
router.get('/profile/fetch/user/', getUserProfile);

router.patch('/profile/edit/user/',
    patchUserProfile
);

router.get('/fetch/studentList/', getUserList);

// Teaching Sessions
router.post('/session/add/', postContestSession);
